...
file_version = False # версия в какую сохранять файл ("False" или "" - задавать вопрос при сохранении)
file_version_name = True # запись версии в имя файла ("False" или "" - не записывать)

directory_open_files = "source" # путь к папке, куда сохранять файлы (для открытых файлов) ("False" или "" - задавать вопрос при сохранении, "source" - рядом с исходником (опция "file_version_name" будет "True"))
...
#-------------------------------------------------------------------------------
file_version = "False" # версия в какую сохранять файл, "False" или "" - задавать вопрос при каждом сохранении
file_version_name = "True" # запись версии в имя файла, "False" или "" - не записывать
#-------------------------------------------------------------------------------
directory_open_files = "source" # путь к папке, куда сохранять файлы (для открытых файлов), "False" или "" - задавать вопрос при каждом сохранении, "source" - рядом с исходником (опция "file_version_name" будет "True")
#-------------------------------------------------------------------------------
...
def Parameters(): # присвоене значений прочитаных параметров
    ...
    global directory_open_files # значение делаем глобальным
    ...
    directory_open_files = parameters.setdefault("directory_open_files", "source") # путь к папке, куда сохранять файлы (для открытых файлов)
...
##        file_version = False # версия файла не задана
        File_version() # определение в какую версию сохранять файл
