...
title = "KSaver"
ver = "v1.4.0.0"
url = "https://github.com/dimak222/KSaver" # ссылка на файл
...
def Check_update(): # обновить приложение
...
def Parameters(): # присвоене значений прочитаных параметров
    ...
    check_update = parameters.setdefault("check_update", True)[0] # опция проверrb обновление программы
    beta = parameters.setdefault("beta", False)[0] # опция скачивания бета версии программы
...
if check_update: # если включена проверка обновления
    Check_update() # обновить приложение
