...
def Parameters(): # присвоене значений прочитаных параметров
    ...
    recursion = parameters.setdefault("recursion", True)[0] # путь к папке, откуда брать файлы (для сохранения из папки)
